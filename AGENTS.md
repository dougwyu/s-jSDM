...
- Unreleased — the current `codex/mojo-release-safety` branch completes seeded-noise generation, replaces shape-keyed buffers with checked high-water capacities, validates raw request sizes, restores one-shot transport, and tightens whole-operation backend selection and release gates.
